                    ...
                    <div class="inshare-table-wrap">
                        <table class="layui-table">
                            ...
                            <tr>
                                ...
                                <td>10</td>
                                <td>
                                    <a class="open-popup" data-title="编辑专利" data-size="600,570" data-url="${pageContext.request.contextPath}/editPatent.action">编辑</a>
                                    <a class="open-popup" data-title="详细信息" data-size="800,600" data-url="${pageContext.request.contextPath}/detailPatent.action">详细</a>

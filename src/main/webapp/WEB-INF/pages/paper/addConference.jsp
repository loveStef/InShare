...
<div class="layui-form inshare-compile inshare-paper">
    <form>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="radio" name="publishstate" value="1" title="已发表" checked><div class="layui-unselect layui-form-radio layui-form-radioed"><i class="layui-anim layui-icon"></i><div>已发表</div></div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="radio" name="language" value="1" title="英文" checked><div class="layui-unselect layui-form-radio layui-form-radioed"><i class="layui-anim layui-icon"></i><div>英文</div></div>
